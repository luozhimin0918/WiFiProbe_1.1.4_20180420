...
/**
 * Created by chenzhy on 2017/10/11.
 */

public class ClearDataUtils {
    private Context context;
    public ClearDataUtils(Context context){
    ...
    public void clearDatabases() {
        WPApplication.gMacTotalInfoDao.deleteAll();
        WPApplication.gRssiInfoDao.deleteAll();
        WPApplication.gMacTotalInfoDao.deleteAll();
        WPApplication.gBrandTotalInfoDao.deleteAll();
        WPApplication.gMacProbeInfoDao.deleteAll();
        WPApplication.gMacStatisticsInfoDao.deleteAll();
    }
